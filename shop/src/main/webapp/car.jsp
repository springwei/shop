...
<body>
		...
		<div class="span10 last">
			<div class="topNav clearfix">
				<ul>
					...
					<c:if test="${sessionScope.frontuser!=null}">
						<li id="headerLogin" class="headerLogin"
							style="display: list-item;"><a href="javascript:void()">${sessionScope.frontuser}</a>|
						</li>
					</c:if>
	...
	<div class="container cart">
		<div class="span24">
					...
					<c:forEach items="${forder.sorderSet}" var="sorder">
						...
						<tr>
							<td width="60"><input type="hidden" name="id"
								value="${sorder.product.pid}"> <img
								src="<%=basePath %>/upload/${sorder.product.pic}"></td>
							<td><a target="_blank"> ${sorder.product.pname}</a></td>
							<td>￥${sorder.product.cprice}</td>
							<td class="quantity" width="60">${sorder.number}</td>
							<td width="140"><span class="subtotal">￥${sorder.price*sorder.number}</span>

							</td>
							<td><a
								href="<%=basePath %>/sorder/delete?pid=${sorder.product.pid}"
			...
			<c:if test="${sessionScope.forder!=null}">
				<div class="total">
					<em id="promotion"></em> 商品金额: <strong id="effectivePrice">￥${forder.total}元</strong>
				</div>
				<div class="bottom">
	...
	<div class="container footer">
		<div class="span24">
			<div class="footerAd">
				<img src="<%=basePath%>/image/footer.jpg" width="950" height="52"

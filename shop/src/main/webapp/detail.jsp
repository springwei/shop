...
<body>
	...
	<div class="container header">
		...
		<div class="span9">
			<div class="headerAd">
				<img src="<%=basePath%>/image/r___________renleipic_01/header.jpg"
		...
		<div class="span18 last">
				...
				<a title="" style="outline-style: none; text-decoration: none;"
					...
					<div class="zoomPad">
						<img style="opacity: 1;" title="" class="medium"
							src="<%=basePath%>/upload/${product.pic}">
						<div
			...
			<div class="info">
				<dl>
					<dt>现价:</dt>
					<dd>
						<strong>￥：${product.cprice}元/份</strong> 原 价：
					...
					<dl class="quantity">
						...
						<dd>
							<input type="hidden" name="pid" value="${product.pid}" /> <input
								id="number" name="number" value="1" maxlength="4"
	...
	<div class="container footer">
		<div class="span24">
			<div class="footerAd">
				<img src="<%=basePath%>/image\r___________renleipic_01/footer.jpg"
